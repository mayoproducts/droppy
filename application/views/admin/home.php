    ...
    <div class="container-xl">
        ...
        <?php if (phpversion() >= '8.2') : ?>
            <div class="alert alert-danger" style="margin: 10px 0 20px 0;">
                ...
                Sorry, but your PHP version (<?php echo phpversion() ?>) is currently not supported by Droppy, at the moment Droppy supports up to PHP 8.1.x<br>
                PHP 8.2 and higher are currently not supported and will cause issues with the frontend uploader. PHP 8.1.x is still actively updated and maintained until the end of 2024 so please use PHP 8.1.x until PHP 8.2 is supported by Droppy.
                <br>
            </div>
        <?php endif; ?>
